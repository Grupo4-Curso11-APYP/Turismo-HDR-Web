				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="# " id="btn-insertar"
							...
							onclick="ShowHideBuscar()">Buscar</a> <a class="collapse-item"
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-600 small"><c:out value="${usuario.nombre}"></c:out></span> <img class="img-profile rounded-circle"
...
<!-- ----------------------------------CRUD-------------------------------------------------- -->
					...
					<div id="insertar-oculto" class="row row-cols-2 row-cols-md-3">
						...
						<div class="col-xl-5 col-lg-6 bg-dark ms-5 mb-3 rounded-2">
							<h2 class="fw-bolder mt-3  text-white">Ingresar Una Nueva Atraccion</h2>

							<form id="form-contact" class="row text-white g-3 needs-validation "
								novalidate>
								<div class="col-md-4">
						...
						<div class="col-xl-5 col-lg-6 bg-dark ms-5 mb-3 rounded-2">
							...
							<h2 class="fw-bolder mt-3 text-white ">Ingresar Una Nueva Promocion</h2>

							<form id="form-contact" class="row text-white g-2 needs-validation mb-3 "
								novalidate>
								<div class="col-md-4">
					...
					<div id="buscar-oculto" class="row row-cols-12 row-cols-xl-12">
						 ...
						 <div class="col-lg-12">
                            <table id="example" class="table  table-bordered table-white  table-hover" style="width:100%">
                                <thead>
                                    <tr class="table-dark">
                                        <th>Nombre</th>
                                        <th>Presupuesto</th>
                    ...
                    <div class="col-xl-4 col-lg-5 bg-dark  ms-5 mb-3 rounded-2">
                        <h2 class="fw-bolder mt-3 text-white">Actualizar Datos de  Atraccion</h2>
                        ...
                        <form id="form-contact" class="row g-3 needs-validation " novalidate>
                            ...
                            <div class="col-md-6">
                                <label for="validationCustom03" class="form-label text-white">Cupo Disponible</label>
                                <input type="text" class="form-control" id="validationCustom03" required>
                                <div class="invalid-feedback text-white">
                                    Por favor ingre un Cupo valido .
                                </div>
                            </div>

                            <div class="col-md-6">
                                <label for="validationCustom02" class="form-label text-white">Tipo de Atraccion</label>
                                <input type="text" class="form-control" id="validationCustom02" required>

                                <div class="invalid-feedback text-white">
                                    por favor ingrese un Tipo de Atraccion valido
                                </div>
                            </div>

                            <div class="col-12">
                                <button class="btn btn-warning mb-3" type="submit">Actualizar Atraccion</button>
                            </div>
                        </form>
                    ...
                    <div class="col-xl-4 col-lg-5 bg-dark  ms-5 mb-3 rounded-2">
                        <h2 class="fw-bolder mt-3 text-white">Actualizar Datos de  Promocion</h2>
                        ...
                        <form id="form-contact" class="row g-2 needs-validation mb-3 " novalidate>
                            ...
                            <div class="col-md-6">
                                <label for="validationCustom02" class="form-label text-white">Atraccion Gratis</label>
                            ...
                            <div class="col-12">
                                <button class="btn btn-warning mb-3" type="submit">Actualizar Promocion</button>
                            </div>
                        </form>
                    ...
                    <!---FIN ACTUALIZACION PROMOS-->
                     ...
                     <div class="col-xl-4 col-lg-5 bg-dark  ms-5 mb-3 rounded-2">
                        <h2 class="fw-bolder mt-3 text-white ">Actualizar Datos de  Usuarios</h2>
                        ...
                        <form id="form-contact" class="row g-2 needs-validation mb-3 " novalidate>
                            ...
                            <div class="col-md-6">
                                <label for="validationCustom02" class="form-label text-white">Tipo Favorito</label>
                                <input type="text" class="form-control" id="validationCustom02">
                            ...
                            <div class="col-12">
                                <button class="btn btn-warning mb-3" type="submit">Actualizar Usuario</button>
                            </div>
                        </form>
                    ...
                    <div id="borrar-oculto" class="row row-cols-12 row-cols-xl-12">
                        <!--BORRAR USUARIO-->
                        <div class="col-xl-4 col-lg-5 bg-dark  ms-5 mb-3 rounded-2">
                        <h2 class="fw-bolder mt-3  text-white">Ingrese el Nombre del Usuario <br> Que desea Eliminar</h2>
                        <form id="form-contact" class="row g-3 needs-validation " novalidate>
                            <div class="col-md-4">
                                <label for="validationCustom01" class="form-label text-white">Nombre</label>
                                <input type="text" class="form-control" id="validationCustom01" required>
                    ...
                    <!--BORRAR ACTRACCION-->
                    <div class="col-xl-4 col-lg-5 bg-dark  ms-5 mb-3 rounded-2">
                        <h2 class="fw-bolder mt-3 text-white ">Ingrese el Nombre de la Atraccion <br> Que desea Eliminar</h2>
                        <form id="form-contact" class="row g-3 needs-validation " novalidate>
                            <div class="col-md-4">
                                <label for="validationCustom01" class="form-label text-white">Nombre</label>
                                <input type="text" class="form-control" id="validationCustom01" required>
                            ...
                            <div class="col-12">
                                <button class="btn btn-danger mb-3" type="submit">Eliminar Atraccion</button>
                            </div>
                        </form>
                        </div>
                    <!--FIN BORRAR ATRACCION-->
                     ...
                     <!--BORRAR PROMOCION-->
                     <div class="col-xl-4 col-lg-5 bg-dark  ms-5 mb-3 rounded-2">
                        <h2 class="fw-bolder mt-3 text-white ">Ingrese el Nombre de la Promocion <br> Que desea Eliminar</h2>
                        <form id="form-contact" class="row g-3 needs-validation " novalidate>
                            <div class="col-md-4">
                                <label for="validationCustom01" class="form-label text-white">Nombre</label>
                                <input type="text" class="form-control" id="validationCustom01" required>
                            ...
                            <div class="col-12">
                                <button class="btn btn-danger mb-3" type="submit">Eliminar Promocion</button>
                            </div>
                        </form>
                        </div>
...
<!-- -------------------------------------------TABLAS ----------------------------------------------------- -->
                    ...
                    <div id="atraccion-oculto" class="row row-cols-12 row-cols-xl-12">
                        ...
                        <div class="col-lg-12">
                            <table id="atraccion" class="table  table-bordered table-white  table-hover"
                                style="width:100%">
                                <thead>
                                    <tr class="table-dark">
                                        <th>Nombre</th>
                    ...
                    <div id="historial-oculto" class="row row-cols-12 row-cols-xl-12">
                        ...
                        <div class="col-lg-12">
                            <table id="historial" class="table  table-bordered table-white  table-hover"
                                style="width:100%">
                                <thead>
                                    <tr class="table-dark">
                                        <th>Nombre</th>
